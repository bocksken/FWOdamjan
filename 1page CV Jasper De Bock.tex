...
\firstname{Jasper}
\familyname{De Bock}
\title{March 2017}  % optional, remove the line if not wanted
...
\address{Ghent University}{Imprecise Probability unit of IDLab}  % optional, remove the line if not wanted
...
\hspace{17pt}As a teaching assistent and co-lecturer, Jasper De Bock has been involved in two courses (at bachelor and master level). He also gave two lectures at the 5th international SIPTA summer school, and has been involved in the supervision of three PhD theses and four master theses.
...
\vspace{5pt}
\small
\cvline{February 2017}{Jasper De Bock. {\itshape The Limit Behaviour of Imprecise Continuous-Time Markov Chains.} Journal of Nonlinear Science, 27(1):159--196. [IF 2015: 2.068]}
\cvline{February 2016}{Jasper De Bock, Arthur Van Camp, M\'arcio A. Diniz \& Gert de Cooman. {\itshape Representation theorems for partially exchangeable random variables.} Fuzzy Sets and Systems, 284:1--30. [IF 2015: 2.098]}
\cvline{December 2015}{Jasper De Bock \& Gert de Cooman. \textit{Conditioning, updating and lower probability zero.} International Journal of Approximate Reasoning, 67:1--36. [IF 2015: 2.696]}
...
\cvline{January 2015}{Jasper De Bock \& Gert de Cooman. {\itshape Credal networks under epistemic irrelevance: the sets of desirable gambles approach.} International Journal of Approximate Reasoning, 56(B):178--207. [IF 2015: 2.696] (invited paper)}
\cvline{May 2014}{Jasper De Bock \& Gert de Cooman. {\itshape An efficient algorithm for estimating state sequences in imprecise hidden Markov models.} Journal of Artificial Intelligence Research, 50:189--233. [IF 2014: 1.257]\vspace{5pt}}
%\vspace{2pt}~
