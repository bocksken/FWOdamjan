...
\textbf{Title of your research proposal} (\textcolor{Gray}{57/240 characters})\\ Basic research on imprecise continuous-time Markov chains\\[8pt]
\textbf{Dutch title} (\textcolor{Gray}{66/240 characters})\\
 Fundamenteel onderzoek naar imprecieze continue-tijd Markov ketens\\[8pt]
\textbf{Summary in layman's terms}\\
\textcolor{Gray}{???/1500 characters}\\
*** WE STILL NEED TO ADD THIS ***

{\bf\color{blue} (Feel free to give this a try)} 
...
*** The text below was added here by Damjan, but I think it is to detailed for the objectives section, and that it would be a better fit the methodology section ***
...
{\bf (Work Package 3c)}: \emph{Stopping times} The goal is the analysis of specific and general stopping times. 
...
%
%
%Classification of the states (transient, recurrent, ...) {\bf\color{blue} (DAMJAN)}
%The second task is 
