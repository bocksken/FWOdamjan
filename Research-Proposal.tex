...
Detailed description of consumables (in full text, max 1500 characters): 14.5 \% of total funds deducted by the institution for administration costs\\
Motivation (in full text, max 1500 characters): the costs automatically charged by the institution \\
Required amount per year:\\
2017: 10663\\
2018: 10663\\
2019: 10663\\
...
{\bf Rent for room}\\
Consumable type: Other\\
Detailed description of consumables (in full text, max 1500 characters): costs of renting room at the faculty \\
Motivation (in full text, max 1500 characters): the researchers paid from research projects are charged for the rooms at the faculty    \\
Required amount per year:\\
2017: 1500\\
2018: 1500\\
2019: 1500\\
...
Consumable type: Small equipment < euro 20000\\
Detailed description of consumables (in full text, max 1500 characters): laptops, displays, printers, software and backup disks for each of the Ljubljana contributors to the project\\
Motivation (in full text, max 1500 characters): this material is indispensable for the type of research we conduct\\
Required amount per year:\\
2017: 8000\\
2018: 4000\\
...
This concept is very important for (precise) stochastic processes, but it has not yet been systematically studied in the framework of imprecision; to the best of our knowledge, the preliminary---and so far unpublished---results in Reference~\cite{skulj:16} are the only exception.
...
Thomas Augustin, Frank P.~A. Coolen, Gert {d}e Cooman, and Matthias C.~M.
  Troffaes, editors.
...
Gert {d}e Cooman, Jasper De~Bock, and Stavros Lopatatzidis.
...
\bibitem{cooman2007d}
Gert {d}e Cooman and Filip Hermans.
...
\bibitem{cooman2009}
Gert {d}e Cooman, Filip Hermans, Alessandro Antonucci, and Marco Zaffalon.
...
\bibitem{cooman2008}
Gert {d}e Cooman, Filip Hermans, and Erik Quaeghebeur.
...
\newblock {\em Probability in the Engineering and Informational Sciences},
  23(4):597--635, January 2009.

\bibitem{hartfiel1998}
Darald~J. Hartfiel.
\newblock {\em {Markov} Set-Chains}.
\newblock Number 1695 in Lecture Notes in Mathematics. Springer, Berlin, 1998.

\bibitem{hermans2012}
Filip Hermans and Gert {d}e Cooman.
...
Damjan in SIPTA 337-344. Troffaes, Matthias C. M. \&~Skulj.
\newblock Model checking for imprecise markov chains.
\newblock In Denoeux Thierry Destercke Sebastien \& Seidenfeld~Teddy Cozman,
  Fabio, editor, {\em ISIPTA'13: Proceedings of the Eighth International
  Symposium on Imprecise Probability: Theories and Applications. Compiegne,
  France,}, 2013.
...
Matthias C.~M. Troffaes, Jacob Gledhill, Damjan \v{S}kulj, and Simon Blake.
...
\newblock In {\em Proceedings of the 9th International Symposium on Imprecise
  Probability: Theories and Applications}, pages 287--294, July 2015.
...
\newblock {\em Finance and Stochastics}, 16(4):561--609, October 2012.
...
\newblock Perturbation bounds and degree of imprecision for uniquely convergent
  imprecise markov chains, 2016.

\bibitem{skulj:16}
Damjan \v{S}kulj.
\newblock Random walks on graphs with interval weights and precise marginals.
\newblock {\em Submitted to International Journal of Approximate Reasoning},
  2016.

\bibitem{skulj2013}
Damjan \v{S}kulj and Robert Hable.
