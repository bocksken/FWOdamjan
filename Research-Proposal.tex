...
Surname: {\v S}kulj\\
Date of birth: {\bf\color{blue}???}\\
Current occupation: {\bf\color{blue}???}\\
Employment (\%): {\bf\color{blue}???}\\
E-mail: {\bf\color{blue}???}\\
Institution: University of Ljubljana\\
Research unit: {\bf\color{blue}???}\\
Street and number: {\bf\color{blue}???}\\
Postal Code: {\bf\color{blue}???}\\
City: {\bf\color{blue}???}\\
Country: {\bf\color{blue}???}\\[5pt]
