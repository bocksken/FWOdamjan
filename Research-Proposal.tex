...
Clearly, this expertise will be a major asset for the project, which aims to develop a theory of \emph{continuous-time} Markov chains. In fact, both project partners have recently started to study this topic, be it in a somewhat preliminary form. The aim of this project is to join forces in our further study of this topic, rather than continue to conduct it separately. We expect this collaboration to be fruitfull because both groups tend to approach the topic of imprecision in Markov chains from partly different and complementary angles.
