...
The two partners for this project were both invited to contribute to the book ``Introduction to Imprecise Probabilities''~\cite{augustin2013:itip}. 
In particular, as a consequence of their mutual interest and expertise in imprecise Markov chains, Damjan Škulj (the foreign supervisor of this project) and Filip Hermans (a former member of the UGhent group) jointly wrote the ``Stochastic processes'' chapter of this book, in which they introduce a general theory of imprecise stochastic processes, with an emphasis on the theory of discrete-time imprecise Markov chains.
