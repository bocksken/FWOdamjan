...
{\bf Unofficial internal deadline Ghent university} \tab 24 March 2016 \\
...
An efficient way of dealing with this problem, is to allow for partially specified parameters, using the theory of imprecise probabilities. {\color{red} It was unclear to one of the jury-members that IP was an extension of probability theory (they seemed to think it was about intervals for deterministic parameters, and were also confusing it with second-order probabilities)... perhaps we should try to rephrase the above...}
...
{\bf Publication costs}\\
Consumable type: Publication costs\\
Detailed description of consumables: open access publication fees {\color{red} It seems strange that these costs are as high as those of Ghent, especially since only half the number of people are involved... could they be reduced? \\
	
I think publication costs can be higher, given that open access fee for one paper could get to 2000 € or more
}\\
Motivation: obvious\\
Required amount per year:\\
2018: 1500\\
...
Detailed description of consumables: 14.5 \% of total funds deducted by the institution for administration costs {\color{red} Are the numbers below still correct? 14.5\% of which number exactly?}\\
...
{\bf Scientific literature}\\
Consumable type: Research expenses\\
Detailed description of consumables: Research books and articles {\color{red} It seems strange that these costs are as high as those of Ghent, especially since only half the number of people are involved... could they be reduced?}\\
Motivation: obvious\\
Required amount per year:\\
2018: 400\\
2019: 400\\
...
Consumable type: Small equipment < euro 20000\\
Detailed description of consumables: laptops, displays, printers, software (Windows, Office, Matlab), cloud storage and backup disks for each of the Ljubljana contributors to the project {\color{red} In this case, the reviewers explicitly mentioned that these expenses are too high (for the three-person team, they suggested to reduce them by 25 to 30 percent, since there are now only two persons, I guess we should reduce them even more) Any specific reason why these expenses are so high?
...
Detailed description of consumables: travel, registration and accommodation costs associated with conferences, as well as travel and accommodation costs associated with research visits between the project partners. {\color{red} It seems strange that these costs are as high as those of Ghent, especially since only half the number of people are involved... could they be reduced?}\\
Motivation: obvious\\
Required amount per year:\\
2018: 4000\\
2019: 5000\\
...
{\color{red} whe should mention that we have already done some work on continuous-time CTMCs during the past year}
...
It currently consists of one post-doc (Jasper De Bock) and four PhD students, who work in a wide range of areas in imprecise probabilities, including credal networks, discrete-time imprecise Markov chains and queueing, and the foundations of statistical and probabilistic inference.
...
\begin{itemize}
\item
We should acknowledge and our incorporate our most recent work on imprecise continuous-time Markov chains
\item
...
\item
One of the reviewers said that the work in http://www.probabilityandfinance.com/articles/43.pdf is relevant, as well as some of the references therein
\item
One of the reviewers suggested to replace [18,19] with Vovk's earlier work in characterising the poisson process: `Forecasting point and continuous processes: prequential analysis', because it is more relevant
\end{itemize}}
...
J. De~Bock.
\newblock {Convergence of Continuous-Time Imprecise Markov Chains}.
\newblock 2016.
...
D.~J. Hartfiel.
\newblock {\em {Markov} Set-Chains}. Springer, Berlin, 1998.
...
\bibitem{skulj2015:continuous:bounds}
D. \v{S}kulj.
\newblock Efficient computation of the bounds of continuous time imprecise
  {M}arkov chains.
\newblock {\em Applied Mathematics and Computation}, 250:165--180, 2015.
