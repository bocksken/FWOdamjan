...
*** Discuss all the different things that have already been succesfully studied in some detail, and especially the things that we intend to generalize to continuous time in this project (except for martingale stuff, because that's already discussed in the previous subsection) ***
...
These algorithms can be used to perform robust queueing analyses~\cite{2015Lopatatzidis}.
}
...
=======
\vspace{5pt}
\emph{State of the art on imprecise continuous-time Markov chains} {\bf\color{blue}(DAMJAN)}\\[5pt]
*** Discuss what has been done already and explain that most problems are still open. ***
...
>>>>>>> 57145252a9e370bc435024e8742549b311373a57
...
>>>>>>> ee60612b3034db42ef5c7fbf1df1918c9a056f84
