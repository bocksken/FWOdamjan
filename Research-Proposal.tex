...
First name: Marco\\
Surname:  Cattaneo\\
Occupation: Lecturer in Mathematics\\
...
Research unit: Istituto "Dalle Molle" \\
...
First name: Fabio\\
Surname:  Cuzzolin\\
Occupation: Reader in Computer Vision\\
...
At Ghent university, the research that is outlined in this project will be conducted by the Imprecise Probability (IP) unit of Data Science Lab, which has world-leading expertise in basic and applied research on imprecise probabilities.
...
Both research partners have strong relations with world's leading researchers in imprecise probabilities. Their members have been active in the organization of the series of biennial ISIPTA conferences (International Symposia on Imprecise Probability: Theories and Applications),  SIPTA summer schools and the series of WPMSIIP workshops (Workshop on Principles and Methods of Statistical Inference with Interval Probability). They have strong ties with other leading research groups in imprecise probabilities, at Carnegie Mellon University (US), IDSIA (Switzerland), Durham University (UK), Universidade de S\~ao Paulo (Brazil), IRIT (France), Ludwig-Maximilians-Universit\"at M\"unchen (Germany), Universidad de Oviedo and Universidad de Granada (Spain), Universiteit Utrecht (The Netherlands), and University of Trieste (Italy). 

They have also been active members of SIPTA society (Society for Imprecise Probability: Theories and Applications), which is an umbrella organization joining the researches on imprecise probabilities from different groups all over the world and promoting their work. 
